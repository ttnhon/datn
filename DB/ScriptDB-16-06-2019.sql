...
INSERT INTO USER_INFO VALUES (N'person20', N'e10adc3949ba59abbe56e057f20f883e', N'P20', N'Phieu', N'person20@gmail.com', 2, N'http://www.iconninja.com/files/155/832/15/business-human-seo-person-user-account-profile-icon.svg', 1, 'Vietnam', 'Description About', 1, 2019, 'facebookLink', 'googleLink',GETDATE())
go
...
--COMPETE
INSERT INTO COMPETE VALUES(1,N'Project code challenge 1', 'project-code-challenge-1', N'Chỉ là mô tả thôi 1', N'Đây là phần rule của compete', 10000, '07/31/2019', 1)
INSERT INTO COMPETE VALUES(1,N'Project code challenge 2', 'project-code-challenge-2', N'Chỉ là mô tả thôi 2', N'Đây là phần rule của compete', 10000, '07/31/2019', 1)
INSERT INTO COMPETE VALUES(1,N'Project code challenge 3', 'project-code-challenge-3', N'Chỉ là mô tả thôi 3', N'Đây là phần rule của compete', 10000, '07/31/2019', 1)
...
INSERT INTO COMPETE VALUES(1,N'Project code challenge 16', 'project-code-challenge-16', N'Chỉ là mô tả thôi 16', N'Đây là phần rule của compete', 10000, '07/31/2019', 1)
INSERT INTO COMPETE VALUES(1,N'Project code challenge 17', 'project-code-challenge-17', N'Chỉ là mô tả thôi 17', N'Đây là phần rule của compete', 10000, '07/31/2019', 1)
INSERT INTO COMPETE VALUES(1,N'Project code challenge 18', 'project-code-challenge-18', N'Chỉ là mô tả thôi 18', N'Đây là phần rule của compete', 10000, '07/31/2019', 1)
INSERT INTO COMPETE VALUES(1,N'Project code challenge 19', 'project-code-challenge-19', N'Chỉ là mô tả thôi 19', N'Đây là phần rule của compete', 10000, '07/31/2019', 1)
INSERT INTO COMPETE VALUES(1,N'Project code challenge 20', 'project-code-challenge-20', N'Chỉ là mô tả thôi 20', N'Đây là phần rule của compete', 10000, '07/31/2019', 1)
go
...
INSERT INTO CHALLENGE VALUES (1, N'For Loop', N'c-tutorial-for-loop', N'test 7', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Cpp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Functions', N'c-tutorial-functions', N'test 8', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Cpp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Pointer', N'c-tutorial-pointer', N'test 9', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Cpp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Arrays Introduction', N'arrays-introduction', N'test 10', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Cpp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Variable Sized Arrays', N'variable-sized-arrays', N'test 11', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Cpp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Attribute Parser', N'attribute-parser', N'test 12', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Cpp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'StringStream', N'c-tutorial-stringstream', N'test 13', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Cpp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Strings', N'c-tutorial-strings', N'test 14', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Cpp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Structs', N'c-tutorial-struct', N'test 15', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Cpp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Class', N'c-tutorial-class', N'test 16', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Cpp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Classes and Objects', N'classes-objects', N'test 17', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Cpp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Box It!', N'box-it', N'test 18', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Cpp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Inherited Code', N'inherited-code', N'test 19', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Cpp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Exceptional Server', N'exceptional-server', N'test 20', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Cpp', 1, 0, 0, 0)
...
<p>When we add several integer values, the resulting sum might exceed the above range. You might need to use long long int in C/C++ or long data type in Java to store such sums.</p>', N'CSharp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Compare the Triplets', N'compare-the-triplets', N'test 24', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'CSharp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Diagonal Difference', N'diagonal-difference', N'test 25', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'CSharp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Mini-Max Sum', N'mini-max-sum', N'test 26', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'CSharp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Birthday Cake Candles', N'birthday-cake-candles', N'test 27', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'CSharp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Grading Students', N'grading', N'test 28', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'CSharp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Apple and Orange', N'apple-and-orange', N'test 29', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'CSharp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Kangaroo', N'kangaroo', N'test 30', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'CSharp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Between Two Sets', N'between-two-sets', N'test 31', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'CSharp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Breaking the Records', N'breaking-best-and-worst-records', N'test 32', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'CSharp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Birthday Chocolate', N'the-birthday-bar', N'test 33', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'CSharp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Divisible Sum Pairs', N'divisible-sum-pairs', N'test 34', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'CSharp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Migratory Birds', N'migratory-birds', N'test 35', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'CSharp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Day of the Programmer', N'day-of-the-programmer', N'test 36', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'CSharp', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Sock Merchant', N'sock-merchant', N'test 37', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'CSharp', 1, 0, 0, 0)
...
</ol>', 1, null, 60, 100, null, N'Java', 1, 0, 0, 0)
...
, N'problem statement', N'There are 3 lines of input, and each line contains a single integer.', null, 1, null, 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
...
N'problem statement', N'<p>A single integer, <strong>N</strong>.</p>', N'<p>Print <strong>10</strong> lines of output; each line <strong>i</strong> (where <strong>1 &lt;= i &lt;= 10</strong>) contains the <strong>result</strong> of <strong>N x i</strong> in the form:&nbsp;<br /><code>N x i = result</code>.</p>', 1, null, 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Java If-Else', N'java-if-else', N'test 44', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Java Stdin and Stdout II', N'java-stdin-stdout', N'test 45', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Java Output Formatting', N'java-output-formatting', N'test 46', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Java Loops II', N'java-loops', N'test 47', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Java Datatypes', N'java-datatypes', N'test 48', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Java End-of-file', N'java-end-of-file', N'test 49', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Java Static Initializer Block', N'java-static-initializer-block', N'test 50', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Java Int to String', N'java-int-to-string', N'test 51', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Java Date and Time', N'java-date-and-time', N'test 52', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Java Currency Formatter', N'java-currency-formatter', N'test 53', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Java Strings Introduction', N'java-strings-introduction', N'test 54', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Java Substring', N'java-substring', N'test 55', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Java Substring Comparisons', N'java-string-compare', N'test 56', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Java String Reverse', N'java-string-reverse', N'test 57', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Java Anagrams', N'java-anagrams', N'test 58', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Java String Tokens', N'java-string-tokens', N'test 59', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
INSERT INTO CHALLENGE VALUES (1, N'Pattern Syntax Checker', N'pattern-syntax-checker', N'test 60', N'problem statement', N'abcd', N'efgh', 1, N'1', 60, 100, N'gdfgdfg', N'Java', 1, 0, 0, 0)
go
...
INSERT INTO TESTCASE VALUES (21, 'challenge_21_input_0.txt', 'challenge_21_output_0.txt')
INSERT INTO TESTCASE VALUES (21, 'challenge_21_input_1.txt', 'challenge_21_output_1.txt')
INSERT INTO TESTCASE VALUES (21, 'challenge_21_input_2.txt', 'challenge_21_output_2.txt')
INSERT INTO TESTCASE VALUES (22, 'challenge_22_input_0.txt', 'challenge_22_output_0.txt')
INSERT INTO TESTCASE VALUES (22, 'challenge_22_input_1.txt', 'challenge_22_output_1.txt')
INSERT INTO TESTCASE VALUES (22, 'challenge_22_input_2.txt', 'challenge_22_output_2.txt')
