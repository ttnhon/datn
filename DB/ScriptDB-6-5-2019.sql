...
GO
--USER_INFO
INSERT INTO USER_INFO VALUES (N'phucphieu', N'e10adc3949ba59abbe56e057f20f883e', N'Phuc', N'Phieu','Vietanm', N'phuc@gmail.com', 1, 1, N'''hahaha''',DEFAULT, 'Description About', 1, 2019, '', '')
INSERT INTO USER_INFO VALUES (N'phucoccho', N'e10adc3949ba59abbe56e057f20f883e', N'Phucvl', N'Phieu','Vietanm', N'phucvl@gmail.com', 1, 1, N'''hahaha''',DEFAULT, 'Description About', 1, 2019, '', '')
INSERT INTO USER_INFO VALUES (N'ngocdeptrai', N'e10adc3949ba59abbe56e057f20f883e', N'hihi', N'Phieu','Vietanm', N'ngocbui@gmail.com', 1, 1, N'''hahaha''',DEFAULT, 'Description About', 1, 2019, '', '')
INSERT INTO USER_INFO VALUES (N'longu', N'e10adc3949ba59abbe56e057f20f883e', N'longml', N'Phieu','Vietanm', N'longporm@gmail.com', 1, 1, N'''hahaha''',DEFAULT, 'Description About', 1, 2019, '', '')
INSERT INTO USER_INFO VALUES (N'myduyen', N'e10adc3949ba59abbe56e057f20f883e', N'Duyen', N'Phieu','Vietanm', N'myduyen@gmail.com', 1, 1, N'''hahaha''',DEFAULT, 'Description About', 1, 2019, '', '')
INSERT INTO USER_INFO VALUES (N'nghiaNgu', N'e10adc3949ba59abbe56e057f20f883e', N'nguvl', N'Phieu','Vietanm', N'nghiangu@gmail.com', 1, 1, N'''hahaha''',DEFAULT, 'Description About', 1, 2019, '', '')
...
--COMPETE
INSERT INTO COMPETE VALUES(1,N'Project code challenge 1', 'project-code-challenge-1', N'Chỉ là mô tả thôi 0', N'Đây là phần rule của compete', 10000, DEFAULT, 10000)
INSERT INTO COMPETE VALUES(1,N'Project code challenge 2', 'project-code-challenge-2', N'Chỉ là mô tả thôi 1', N'Đây là phần rule của compete', 10000, DEFAULT, 10000)
INSERT INTO COMPETE VALUES(1,N'Project code challenge 3', 'project-code-challenge-3', N'Chỉ là mô tả thôi 2', N'Đây là phần rule của compete', 10000, DEFAULT, 10000)
INSERT INTO COMPETE VALUES(1,N'Project code challenge 4', 'project-code-challenge-4', N'Chỉ là mô tả thôi 3', N'Đây là phần rule của compete', 10000, DEFAULT, 10000)
INSERT INTO COMPETE VALUES(1,N'Project code challenge 5', 'project-code-challenge-5', N'Chỉ là mô tả thôi 4', N'Đây là phần rule của compete', 10000, DEFAULT, 10000)
INSERT INTO COMPETE VALUES(1,N'Project code challenge 6', 'project-code-challenge-6', N'Chỉ là mô tả thôi 5', N'Đây là phần rule của compete', 10000, DEFAULT, 10000)
INSERT INTO COMPETE VALUES(1,N'Project code challenge 7', 'project-code-challenge-7', N'Chỉ là mô tả thôi 6', N'Đây là phần rule của compete', 10000, DEFAULT, 10000)
INSERT INTO COMPETE VALUES(1,N'Project code challenge 8', 'project-code-challenge-8', N'Chỉ là mô tả thôi 7', N'Đây là phần rule của compete', 10000, DEFAULT, 10000)
INSERT INTO COMPETE VALUES(1,N'Project code challenge 9', 'project-code-challenge-9', N'Chỉ là mô tả thôi 8', N'Đây là phần rule của compete', 10000, DEFAULT, 10000)

--CHALLENGE
INSERT INTO CHALLENGE VALUES (1, N'''Print Hello world!''', N'''print-hello-world''', N'''Tét thôi ghi đại di''', N'''hahaha''', N'''hahaha''', 1, N'1', 60, 100, N'''tét thôi''', N'''hahahahaha''', N'''{"Cpp"}''')
INSERT INTO CHALLENGE VALUES (2, N'test number 2', N'test-number-2', N'test 2', N'fadfd', N'sfgfgf', 1, N'1', 60, 100, N'gdfgdfg', N'ttttt', N'{"CSharp"}')
INSERT INTO CHALLENGE VALUES (3, N'test number 3', N'test-number-3', N'test 3', N'fadfd', N'sfgfgf', 1, N'1', 60, 100, N'gdfgdfg', N'ttttt', N'{"CSharp"}')
INSERT INTO CHALLENGE VALUES (4, N'test number 4', N'test-number-4', N'test 4', N'fadfd', N'sfgfgf', 1, N'1', 60, 100, N'gdfgdfg', N'ttttt', N'{"CSharp"}')
INSERT INTO CHALLENGE VALUES (5, N'test number 5', N'test-number-5', N'test 5', N'fadfd', N'sfgfgf', 1, N'1', 60, 100, N'gdfgdfg', N'ttttt', N'{"CSharp"}')
INSERT INTO CHALLENGE VALUES (6, N'test number 6', N'test-number-2', N'test 2', N'fadfd', N'sfgfgf', 1, N'1', 60, 100, N'gdfgdfg', N'ttttt', N'{"CSharp"}')
INSERT INTO CHALLENGE VALUES (1, N'test number 7', N'test-number-3', N'test 3', N'fadfd', N'sfgfgf', 1, N'1', 60, 100, N'gdfgdfg', N'ttttt', N'{"CSharp"}')
INSERT INTO CHALLENGE VALUES (2, N'test number 8', N'test-number-4', N'test 4', N'fadfd', N'sfgfgf', 1, N'1', 60, 100, N'gdfgdfg', N'ttttt', N'{"CSharp"}')
INSERT INTO CHALLENGE VALUES (3, N'test number 9', N'test-number-5', N'test 5', N'fadfd', N'sfgfgf', 1, N'1', 60, 100, N'gdfgdfg', N'ttttt', N'{"CSharp"}')
INSERT INTO CHALLENGE VALUES (4, N'test number 10', N'test-number-2', N'test 2', N'fadfd', N'sfgfgf', 1, N'1', 60, 100, N'gdfgdfg', N'ttttt', N'{"CSharp"}')
INSERT INTO CHALLENGE VALUES (5, N'test number 11', N'test-number-3', N'test 3', N'fadfd', N'sfgfgf', 1, N'1', 60, 100, N'gdfgdfg', N'ttttt', N'{"CSharp"}')
INSERT INTO CHALLENGE VALUES (6, N'test number 12', N'test-number-4', N'test 4', N'fadfd', N'sfgfgf', 1, N'1', 60, 100, N'gdfgdfg', N'ttttt', N'{"CSharp"}')
INSERT INTO CHALLENGE VALUES (1, N'test number 13', N'test-number-5', N'test 5', N'fadfd', N'sfgfgf', 1, N'1', 60, 100, N'gdfgdfg', N'ttttt', N'{"CSharp"}')
